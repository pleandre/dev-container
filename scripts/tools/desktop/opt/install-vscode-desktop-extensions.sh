...
EXTENSIONS="/opt/dev-container/desktop/vscode-desktop-extensions.json"
INSTALLED_EXTENSIONS="/opt/dev-container/desktop/data/installed-vscode-desktop-extensions.txt"
